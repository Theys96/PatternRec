...
%KNN
dim = size(cat1,1)
dataKNN = [cat1; cat2; cat3];
labels = zeros(1,3*dim);
labels(1:dim) = 1;
labels(dim+1:2*dim) = 2;
labels(2*dim+1:3*dim) = 3;

Q28 = KNN(u,1,dataKNN,labels)
Q29 = KNN(v,1,dataKNN,labels)
Q30 = KNN(w,1,dataKNN,labels)
Q31 = KNN(u,5,dataKNN,labels)
Q32 = KNN(v,5,dataKNN,labels)
Q33 = KNN(w,5,dataKNN,labels)